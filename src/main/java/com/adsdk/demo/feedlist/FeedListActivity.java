...
//                                                .addViewStyle(ViewStyle.STYLE_DESC,descStyle);
         ...
         *
         * 1、广告请求和展示在同一个页面
         *      创建AdRequest时传入的Activity，要确保是广告展示页的Activity；
         *      广告展示调用AdView#render()方法
         * 2、广告请求和展示不在同一个页面
         *      创建AdRequest时传入的Activity，不做强制要求，可以和展示页Activity不同；
         *      广告展示调用AdView#render(Activity)，传入的Activity必须是广告展示页的Activity
         *
         *
         */
    ...
    class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(final CustomViewHolder customViewHolder, final int position) {
            ...
            if (TYPE_AD == type) {
                ...
                /**
                 * 请求模板广告会返回AdView，调用AdView#render广告才会展示
                 *
                 * 调用AdView#render()，要确保广告展示页面Activity和创建AdRequest时传入的Activity一样
                 *
                 * 调用AdView#render(Activity)，传入的Activity是广告展示页面的Activity
                 *
                 */
