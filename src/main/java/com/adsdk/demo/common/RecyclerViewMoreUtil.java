 ...
 *@date 创建时间 2017/2/16
 *@author YMH
 *@name RecyclerViewMoreUtil
 *@introduce 配合原生RecyclerVew加载更多
*/
public class RecyclerViewMoreUtil {
    ...
    public RecyclerViewMoreUtil() {

    }

    public void init(final Context context, RecyclerView recyclerView, final RecyclerView.Adapter adapter, final RefreshDataListener refreshDataListener) {
        initConfig(context, recyclerView, adapter, refreshDataListener);
...
//                            ToastUtil.showToast(mContext, "加载更多", Toast.LENGTH_SHORT);
                        } else {
//                            Toast.makeText(mContext, "不能加载更多", Toast.LENGTH_SHORT).show();
    ...
    private void initConfig(Context context, RecyclerView recyclerView, RecyclerView.Adapter adapter, RefreshDataListener refreshDataListener) {
